...
class TweetsHandler:
    def __init__(self):
        """this is just a test for the stand-alone authetication class"""
        self.consumer_token = 'your twitter API Key here'
        self.consumer_secret = 'your twitter secret API Key here'
        self.auth = tweepy.OAuthHandler(self.consumer_token, self.consumer_secret)
        try:
            self.auth.set_access_token('your oauth_access_token here',
            'your oauth_access_secret here')
